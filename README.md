...
The content of the events page can be changed here:`/events.html`
...
```
#####Project post
Create a Project post to go in your events by creating a file called `yyyy-mm-dd-name-of-the-project.markdown` in the `/_posts/project/` directory with the following template:
```markdown
---
...
img: events_10.jpg #place image (600x450) with this name in /assets/img/project/
thumb: thumb02.jpg
carousel:
